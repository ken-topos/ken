...
- Carriers: `data List a = Nil | Cons a (List a)` /
  ...
  indformers. `list_append` landed (`catalog/packages/Data/Collections/Derived.ken.md:52`,
  ...
  (`catalog/packages/Core/Classes/`). **NOT yet landed:**
...
`catalog/packages/Core/Classes/` additions carrying real `elim_List`/`elim_Option`
