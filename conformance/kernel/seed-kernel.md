...
## kernel/conversion/sct-accepts-lexicographic
...
## kernel/conversion/sct-rejects-nonterminating (soundness)
- spec: `spec/10-kernel/17-conversion.md §4`
...
## kernel/judgments/certificate-recheck (soundness)
