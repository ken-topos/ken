...
> `const` / `fn` / `proc`, `prop`, `theorem`, and attached `proof`.
>
...
> `const` / `fn` / `proc`, `prop`, `theorem`, and attached `proof` forms; no
...
> `record`, `const` / `fn` / `proc`, `prop`, `theorem`, and attached `proof`; no
...
> `const` / `fn` / `proc`, `prop`, `theorem`, and attached `proof` forms. Because
...
> `const` / `fn` / `proc`, `prop`, `theorem`, and attached `proof`. The WP must
...
> `record`, `const` / `fn` / `proc`, `prop`, `theorem`, and attached `proof`
...
> math-facing `def` surface form after `prop`, `theorem`, and attached `proof`, or
> whether `type`, `const` / `fn`, `record`, `prop`, `theorem`, and `proof` already
...
> `prop`, `theorem`, attached `proof`, `::`, or explicit attached-proof telescope
...
> `prop`, standalone `theorem`, and attached `proof <name> for <subject>` are in
...
> attached-proof independence, and `theorem` as the ordinary-module factoring
