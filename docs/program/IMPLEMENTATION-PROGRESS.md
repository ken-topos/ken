...
2026-07-25 04:03:31Z — from 73 issue file(s) in `docs/program/issues/`.
...
| `RT-FNSPLIT-B2A-C` | plan↔lowering occurrence correspondence — transport the preallocated StaticOriginId to the site where it is out of scope | active | runtime | M | none | — |
