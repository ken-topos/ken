...
2026-07-21 22:06:53Z — from 23 issue file(s) in `docs/program/issues/`.
...
| `DOC-W0` | documentation Wave 0 — library/ charter and currency substrate | active | librarian | M | none | — |
