...
2026-08-02 06:06:40Z — from 155 issue file(s) in `docs/program/issues/`.
...
- `DOC-W5D-INDEXES` — Wave 5 closeout — build the four cross-package indexes the cards can support (declaration/type, law, effect/capability, assurance) and record why the four held-class indexes cannot be built
