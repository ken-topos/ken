...
2026-07-24 22:40:51Z — from 48 issue file(s) in `docs/program/issues/`.
...
- `RT-PLANNER-ATTRIB-K` — Boundary A planner: fixed K is a design invariant — move the K-exceeded rejection off the capacity channel
