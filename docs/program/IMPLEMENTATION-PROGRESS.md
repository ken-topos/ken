...
2026-07-24 17:43:39Z — from 43 issue file(s) in `docs/program/issues/`.
...
| `DOC-VALIDATION-BINDING` | validation vocabulary claims a 1:1 binding to the gates; nothing binds it | active | verify | S | none | — |
