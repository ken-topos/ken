...
2026-07-26 00:24:17Z — from 80 issue file(s) in `docs/program/issues/`.
...
| `RT-SCALE-A` | Boundary A — re-derive the planner census for n=3..7 against the COMPLETED factored representation, superseding the provisional outer-planner numbers | draft | runtime | M | none | — |
...
- `RT-SCALE-A` blocked by `RT-FNSPLIT-B2F` (status: ready)
- `RT-SCALE-B` blocked by `RT-SCALE-A` (status: draft)
