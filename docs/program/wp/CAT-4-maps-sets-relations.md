...
capstone** (`catalog/packages/Data/Collections/Map.ken.md`, `spec/50-stdlib/52-map.md` +
...
> below is **perishable** — re-verify `catalog/packages/Data/Collections/Map.ken.md` +
...
- **AC7 — green.** `cargo test --workspace` + rosetta (16/0) green; extends
  `catalog/packages/Data/Collections/` (MANIFEST + derivation path updated).
...
Grounded on `origin/main @ 7169300f` (`catalog/packages/Data/Collections/Map.ken.md` (2225
lines),
`54`/`52`, `10-kernel/16 §1.1–§1.4`/`§6`, `catalog/packages/Core/Classes/
