...
`Capability.Diagnostics.Render` is the presentation layer shared by command-line and
...
The renderer is a transparent structural projection into `Capability.Formatting.Doc`. It adds
