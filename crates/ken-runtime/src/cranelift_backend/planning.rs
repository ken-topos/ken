...
pub(super) use static_transition::{
    planned_partiality_trap, AggregateRepresentationToken, BoundaryUseIdentity,
    ConstructorIdentity, EffectSemanticSeat, JoinPlanToken, JoinResultRepresentation,
    LoweringOnlyOperandEdge, OperandEdgeDisposition, OperandEdgeToken, SourceOperandRole,
    StaticOriginId, StaticRecursorCaptureLifetime, StaticRecursorWorkerResidualId,
    StaticTransitionPlan, SynthesizedAggregateOccurrence, SynthesizedAggregateSite,
