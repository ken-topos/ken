...
use crate::{RuntimeDeclaration, RuntimeExpr, RuntimeObservation, RuntimeProgram, RuntimeValue};
...
use compiled::*;
// api-owned entrypoints the residual facade still calls; the residual facade
// becomes the explicit re-export facade in slice 7.
...
// a widening (§10.4) — AC-7 ledger unchanged.
...
#[cfg(test)]
use crate::{
    fnv1a_64, validate_supported_runtime_artifact_certificate, RuntimeArtifactCertificate,
    RuntimeArtifactIdentity, RuntimeEffectBoundary, RuntimeExample, RuntimeLowerabilityStatus,
};
