...
mod tests {
    use super::*;
    use ken_host::{
        CanonicalOutcomeV1, CanonicalReplyV1, CapabilityAuthorityV1, CapabilityGrantV1,
        CapabilityTraceIdentity, CreatePolicyV1, FileErrorCauseV1, IoErrorIdentityV1,
        RIGHT_READ_V1, RIGHT_WRITE_V1,
    };
    ...
    fn invocation(rights: u8) -> (KenNativeInvocationV1<MockHost>, CapabilityTokenV1) {
        ...
        let token = capabilities.insert(CapabilityGrantV1 {
            ...
            authority: CapabilityAuthorityV1::Partial,
            rights,
        });
        (
